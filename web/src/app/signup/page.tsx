...
export default function SignupPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const result = await signup(email, password, firstName, birthday, gender, lastName);
    ...
    const handleGoogleLogin = async () => {
        ...
        setTimeout(() => {
            setIsLoading(false);
            alert("Google Login requires configuration.");
        }, 1000);
    };
    ...
    const handleAppleLogin = async () => {
        ...
        setTimeout(() => {
            setIsLoading(false);
            alert("Apple Login requires configuration.");
        }, 1000);
    };
