    ...
    return (
        <main className="min-h-screen">
            ...
            <div className="p-4 space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="w-full p-4 bg-[#1A1A24] rounded-xl flex justify-between items-center">
                            ...
                            <button
                                ...
                                className={`w-12 h-6 rounded-full transition ${notifications ? 'bg-pink-500' : 'bg-gray-600'}`}
                            >
                ...
                {/* Logout */}
                <button className="w-full p-4 bg-[#1A1A24] rounded-xl text-pink-400 font-semibold hover:bg-gray-800 transition">
                    {t('settings.logout')}
                </button>
            </div>
